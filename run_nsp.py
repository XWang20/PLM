...
from RobertaForNextSentencePrediction import RobertaForNextSentencePrediction
import transformers

from transformers import TextDatasetForNextSentencePrediction
from transformers import DataCollatorForLanguageModeling
from transformers import Trainer, TrainingArguments, HfArgumentParser, set_seed, AutoConfig
...
def main():
    ...
    tokenizer = Tokenizer.from_pretrained(model_args.model_name_or_path, **tokenizer_kwargs)
    
    model = RobertaForNextSentencePrediction.from_pretrained(
